mainApp.config(function($translateProvider) {
    ...
    $translateProvider.translations('en', {
        ...
        'event.front.rewards.startSharingGroup': 'or ask for a group link to start sharing!',
        'event.front.rewards.startSharingRef': 'to start sharing!',
    ...
    $translateProvider.translations('fi', {
        ...
        'event.front.rewards.logIn': 'Kirjaudu',
        'event.front.rewards.startSharingGroup': 'tai pyydä ryhmälinkkiä aloittaaksesi jakamisen!',
        'event.front.rewards.startSharingRef': 'aloittaaksesi jakamisen!',
